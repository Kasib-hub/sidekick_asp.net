...
namespace sidekick_backend.Controllers
{
  ...
  public class SolutionController : ControllerBase
  {
    ...
    [HttpGet("GetAll")]
    public async Task<ActionResult<ServiceResponse<List<GetSolutionResponseDto>>>> Get()
    {
    ...
    [HttpGet("{Id}")]
    public async Task<ActionResult<ServiceResponse<GetSolutionResponseDto>>> GetSingle(int Id)
    {
      // 200 status code
    ...
    [HttpPost]
    public async Task<ActionResult<ServiceResponse<GetSolutionResponseDto>>> CreateSolution(CreateSolutionResponseDto solution)
    {
